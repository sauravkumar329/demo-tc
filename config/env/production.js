...
module.exports = {
  ...
  datastores: {
    ...
    ***************************************************************************/
    default: {
      ...
      user: 'bTYGLTQnnN', //optional
      password: 'FyVyqbt04c', //optional
      database: 'bTYGLTQnnN' //optional
    //    adapter: 'sails-mysql',
    // host: 'remotemysql.com',
    // user: 'Cj6Nt0kT2P', //optional
    // password: '7ujdtrdpdX', //optional
    // database: 'Cj6Nt0kT2P' //optional
      // adapter: 'sails-mysql',
  ...
  ***************************************************************************/
  session: {
    ...
    *                                                                          *
    ***************************************************************************/
  //  secret: '78b7fc73cf1a43d62af20760aa8a7f1d',
   cookie: {
     maxAge: 3 * 60 * 1000,
     httpOnly: true,
     secure: true
